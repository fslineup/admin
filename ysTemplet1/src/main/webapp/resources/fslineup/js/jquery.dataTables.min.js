...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No data available in table",sInfo:"검색된 _TOTAL_ 경기중 _START_ ~ _END_",sInfoEmpty:"검색된 0 경기중 0~0",sInfoFiltered:"(총 _MAX_ 개의 경기)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"show _MENU_ 개씩",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"검색:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"검색된 결과가 없습니다."},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
